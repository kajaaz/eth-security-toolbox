// Credits : code inspired by Moses Maina's implementation
...
class App extends Component {
  ...
  // Perform request to server API using Axios
  componentDidMount() {
    axios.get("/api/get")
        .then((response) => {
            this.setState({
  ...
  // Adding the necessary input texts and buttons that will handle the necessary 
  // states and response data
  render() {
